...
class RecipeView {
    ...
    #data;
    errorMassage = 'sizning malumotingiz topilmadi iltimos qaytadan urunib koring';
    render(data) {
        this.#data = data;
        if (!data) return;
        this.#clearHTML();
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}]},["ddCAb","aenu9"], "aenu9", "parcelRequire0d48")
